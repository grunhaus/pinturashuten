    ...
    <div className="overflow-hidden">
      ...
      <section>
        <div className="container">
          <div className="relative rounded-3xl overflow-hidden min-h-[550px] lg:min-h-[700px] flex items-center">
            {/* Video Background */}
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center py-16 lg:py-24">
                <div>
                  <Animated animation="fade-up">
                    <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-white/10 text-white/80 text-xs font-medium tracking-wide uppercase mb-8">
                      Desde 2004
                    </span>
                  </Animated>
                  ...
                  <Animated animation="fade-up" delay={300}>
                    <div className="flex flex-wrap items-center gap-4">
                      <Button size="lg" className="h-14 px-8 text-base bg-white text-black hover:bg-white/90 rounded-full" asChild>
                        <Link href="/productos/fondo-esmalte">
                          Explorar Productos
                          <ArrowRight className="w-4 h-4 ml-2" />
                        </Link>
                      </Button>
                      <Button size="lg" variant="ghost" className="h-14 px-6 text-base text-white hover:bg-white/10 rounded-full" asChild>
                        <Link href="/nosotros">
                          Conocer Más
                        </Link>
                      </Button>
      ...
      <section className="py-5">
        <div className="container">
          <Animated animation="fade-up">
            <div className="flex items-center justify-between gap-6 px-8 py-4 bg-black text-white rounded-2xl">
              ...
              <Animated animation="fade-up" delay={300}>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="p-5 rounded-2xl bg-muted/50">
                    <Shield className="w-6 h-6 mb-3 text-foreground/70" />
                  ...
                  <div className="p-5 rounded-2xl bg-muted/50">
                    <Factory className="w-6 h-6 mb-3 text-foreground/70" />
                    <h4 className="font-semibold mb-1">100% Nacional</h4>
                    <p className="text-sm text-muted-foreground">Producción propia</p>
                  </div>
                </div>
              </Animated>
            </div>
      ...
      <section className="py-12">
        <div className="container">
          <Animated animation="scale-in">
            <div className="bg-black text-white rounded-3xl p-10 lg:p-16">
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                  <Animated animation="fade-up">
                  ...
                  <Animated animation="fade-up" delay={300}>
                    <div className="grid grid-cols-2 gap-4 mb-8">
                      <div className="p-4 rounded-xl bg-white/5">
                        <div className="text-3xl font-bold">30<span className="text-lg text-white/50 ml-1">min</span></div>
                        <div className="text-sm text-white/40">Secado al tacto</div>
                      </div>
                      <div className="p-4 rounded-xl bg-white/5">
                        <div className="text-3xl font-bold">2<span className="text-lg text-white/50 ml-1">en 1</span></div>
                        <div className="text-sm text-white/40">Fondo y esmalte</div>
                      </div>
                    </div>
                  </Animated>

                  <Animated animation="fade-up" delay={400}>
                    <Button size="lg" className="h-14 px-8 bg-white text-black hover:bg-white/90 rounded-full" asChild>
                      <Link href="/productos/fondo-esmalte">
                ...
                <Animated animation="fade-left" delay={200}>
                  <div className="flex items-center justify-center">
                    <div className="relative">
                      ...
                      <div className="absolute -top-2 -right-2 px-4 py-2 rounded-full bg-white text-black text-sm font-medium">
                        RAL
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-24">
        <div className="container">
          <Animated animation="fade-up">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="text-4xl sm:text-5xl">Sectores Industriales</h2>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            {/* Row 1 */}
            <Animated animation="fade-up" delay={100} className="lg:col-span-3">
              <Link
              ...
              >
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <h3 className="text-2xl font-bold text-white mb-1">Vehículos y Maquinaria</h3>
                  <p className="text-white/70 text-sm">Chasis, carrocerías y equipos industriales</p>
                </div>
              </Link>
            </Animated>

            <Animated animation="fade-up" delay={200} className="lg:col-span-3">
              <Link
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <h3 className="text-2xl font-bold text-white mb-1">Construcción</h3>
                  <p className="text-white/70 text-sm">Estructuras metálicas y arquitectónicas</p>
                </div>
              </Link>
            </Animated>

            {/* Row 2 */}
            <Animated animation="fade-up" delay={300} className="lg:col-span-2">
              <Link
                href="/aplicaciones/naval"
                className="group relative rounded-2xl overflow-hidden h-[240px] block"
              >
                <div
                  className="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-105"
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <h3 className="text-xl font-bold text-white mb-1">Naval y Marítima</h3>
                  <p className="text-white/60 text-sm">Embarcaciones y puertos</p>
                </div>
              </Link>
            </Animated>

            <Animated animation="fade-up" delay={400} className="lg:col-span-2">
              <Link
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <h3 className="text-xl font-bold text-white mb-1">Energía</h3>
                  <p className="text-white/60 text-sm">Plantas y subestaciones</p>
                </div>
              </Link>
            </Animated>

            <Animated animation="fade-up" delay={500} className="lg:col-span-2">
              <Link
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
                <div className="absolute inset-0 p-6 flex flex-col justify-end">
                  <h3 className="text-xl font-bold text-white mb-1">Petróleo y Gas</h3>
                  <p className="text-white/60 text-sm">Tuberías y plataformas</p>
                </div>
              </Link>
            </Animated>
          </div>
          ...
          <Animated animation="fade-up">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="text-4xl sm:text-5xl">Colores Disponibles</h2>
              </div>
            ...
            <div className="grid grid-cols-6 sm:grid-cols-8 md:grid-cols-12 gap-2 mb-6">
              {colors.map((color) => (
                <Link
                  ...
                  className="aspect-square rounded-lg hover:scale-110 hover:z-10 transition-all duration-300"
          ...
          <Animated animation="fade-up">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="text-4xl sm:text-5xl">Noticias</h2>
              </div>
              <Button variant="outline" className="rounded-full w-fit" asChild>
                <Link href="/noticias">
                  Ver Todas
            ...
            <div className="space-y-4">
              {faqs.map((faq, i) => (
                <Animated key={faq.id} animation="fade-up" delay={100 + i * 100}>
                  <details className="group bg-white rounded-2xl border border-border/50 overflow-hidden">
                    <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                      <span className="font-semibold pr-6">{faq.question}</span>
                      <span className="flex-shrink-0 w-8 h-8 rounded-full bg-muted flex items-center justify-center group-open:rotate-45 transition-transform duration-300">
      ...
      <section className="py-12">
        <div className="container">
          <Animated animation="scale-in">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 p-12 lg:p-20">
              {/* Background pattern */}
              ...
              <div className="relative max-w-3xl mx-auto text-center">
                ...
                <Animated animation="fade-up" delay={200}>
                  <div className="flex flex-wrap justify-center gap-4">
                    <Button size="lg" className="h-14 px-10 text-base bg-white text-black hover:bg-white/90 rounded-full" asChild>
                      <Link href="/contacto">
                        Solicitar Cotización
                        <ArrowRight className="w-4 h-4 ml-2" />
                      </Link>
                    </Button>
                    <Button size="lg" variant="outline" className="h-14 px-10 text-base rounded-full border-white/20 text-white hover:bg-white/10" asChild>
                      <Link href="/productos/fondo-esmalte">
                        Ver Productos
                      </Link>
                    </Button>
